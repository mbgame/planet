...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Bn,depthTest:!1,depthWrite:!1})}function Ll(){return new Gn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Yo(),fragmentShader:`
		...
		`,blending:Bn,depthTest:!1,depthWrite:!1})}function Dl(){return new Gn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Yo(),fragmentShader:`
...
`)+`
`+d);const w=y+f+o,S=y+d+a,N=kl(r,r.VERTEX_SHADER,w),C=kl(r,r.FRAGMENT_SHADER,S);r.attachShader(b,N),r.attachShader(b,C),e.index0AttributeName!==void 0?r.bindAttribLocation(b,0,e.index0AttributeName):e.morphTargets===!0&&r.bindAttribLocation(b,0,"position"),r.linkProgram(b);function A(O){if(n.debug.checkShaderErrors){const j=r.getProgramInfoLog(b).trim(),P=r.getShaderInfoLog(N).trim(),W=r.getShaderInfoLog(C).trim();let q=!0,H=!0;if(r.getProgramParameter(b,r.LINK_STATUS)===!1)if(q=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(r,b,N,C);else{const it=Vl(r,N,"vertex"),G=Vl(r,C,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(b,r.VALIDATE_STATUS)+`
...
}`;function yv(n,t,e){let i=new qo;const r=new bt,s=new bt,o=new ie,a=new Mv({depthPacking:nd}),l=new wv,c={},u=e.maxTextureSize,h={[zn]:Pe,[Pe]:zn,[mn]:mn},p=new Gn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new bt},radius:{value:4}},vertexShader:Ev,fragmentShader:Sv}),m=p.clone();m.defines.HORIZONTAL_PASS=1;const v=new jn;v.setAttribute("position",new en(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const b=new Oe(v,p),f=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Cc;let d=this.type;this.render=function(C,A,z){if(f.enabled===!1||f.autoUpdate===!1&&f.needsUpdate===!1||C.length===0)return;const E=n.getRenderTarget(),x=n.getActiveCubeFace(),O=n.getActiveMipmapLevel(),j=n.state;j.setBlending(Bn),j.buffers.color.setClear(1,1,1,1),j.buffers.depth.setTest(!0),j.setScissorTest(!1);const P=d!==fn&&this.type===fn,W=d===fn&&this.type!==fn;for(let q=0,H=C.length;q<H;q++){const it=C[q],G=it.shadow;if(G===void 0){console.warn("THREE.WebGLShadowMap:",it,"has no shadow.");continue}if(G.autoUpdate===!1&&G.needsUpdate===!1)continue;r.copy(G.mapSize);const Q=G.getFrameExtents();if(r.multiply(Q),s.copy(G.mapSize),(r.x>u||r.y>u)&&(r.x>u&&(s.x=Math.floor(u/Q.x),r.x=s.x*Q.x,G.mapSize.x=s.x),r.y>u&&(s.y=Math.floor(u/Q.y),r.y=s.y*Q.y,G.mapSize.y=s.y)),G.map===null||P===!0||W===!0){const dt=this.type!==fn?{minFilter:Ge,magFilter:Ge}:{};G.map!==null&&G.map.dispose(),G.map=new ai(r.x,r.y,dt),G.map.texture.name=it.name+".shadowMap",G.camera.updateProjectionMatrix()}n.setRenderTarget(G.map),n.clear();const J=G.getViewportCount();for(let dt=0;dt<J;dt++){const Ot=G.getViewport(dt);o.set(s.x*Ot.x,s.y*Ot.y,s.x*Ot.z,s.y*Ot.w),j.viewport(o),G.updateMatrices(it,dt),i=G.getFrustum(),S(A,z,G.camera,it,this.type)}G.isPointLightShadow!==!0&&this.type===fn&&y(G,z),G.needsUpdate=!1}d=this.type,f.needsUpdate=!1,n.setRenderTarget(E,x,O)};function y(C,A){const z=t.update(b);p.defines.VSM_SAMPLES!==C.blurSamples&&(p.defines.VSM_SAMPLES=C.blurSamples,m.defines.VSM_SAMPLES=C.blurSamples,p.needsUpdate=!0,m.needsUpdate=!0),C.mapPass===null&&(C.mapPass=new ai(r.x,r.y)),p.uniforms.shadow_pass.value=C.map.texture,p.uniforms.resolution.value=C.mapSize,p.uniforms.radius.value=C.radius,n.setRenderTarget(C.mapPass),n.clear(),n.renderBufferDirect(A,null,z,p,b,null),m.uniforms.shadow_pass.value=C.mapPass.texture,m.uniforms.resolution.value=C.mapSize,m.uniforms.radius.value=C.radius,n.setRenderTarget(C.map),n.clear(),n.renderBufferDirect(A,null,z,m,b,null)}function w(C,A,z,E){let x=null;const O=z.isPointLight===!0?C.customDistanceMaterial:C.customDepthMaterial;if(O!==void 0)x=O;else if(x=z.isPointLight===!0?l:a,n.localClippingEnabled&&A.clipShadows===!0&&Array.isArray(A.clippingPlanes)&&A.clippingPlanes.length!==0||A.displacementMap&&A.displacementScale!==0||A.alphaMap&&A.alphaTest>0||A.map&&A.alphaTest>0){const j=x.uuid,P=A.uuid;let W=c[j];W===void 0&&(W={},c[j]=W);let q=W[P];q===void 0&&(q=x.clone(),W[P]=q,A.addEventListener("dispose",N)),x=q}if(x.visible=A.visible,x.wireframe=A.wireframe,E===fn?x.side=A.shadowSide!==null?A.shadowSide:A.side:x.side=A.shadowSide!==null?A.shadowSide:h[A.side],x.alphaMap=A.alphaMap,x.alphaTest=A.alphaTest,x.map=A.map,x.clipShadows=A.clipShadows,x.clippingPlanes=A.clippingPlanes,x.clipIntersection=A.clipIntersection,x.displacementMap=A.displacementMap,x.displacementScale=A.displacementScale,x.displacementBias=A.displacementBias,x.wireframeLinewidth=A.wireframeLinewidth,x.linewidth=A.linewidth,z.isPointLight===!0&&x.isMeshDistanceMaterial===!0){const j=n.properties.get(x);j.light=z}return x}function S(C,A,z,E,x){if(C.visible===!1)return;if(C.layers.test(A.layers)&&(C.isMesh||C.isLine||C.isPoints)&&(C.castShadow||C.receiveShadow&&x===fn)&&(!C.frustumCulled||i.intersectsObject(C))){C.modelViewMatrix.multiplyMatrices(z.matrixWorldInverse,C.matrixWorld);const P=t.update(C),W=C.material;if(Array.isArray(W)){const q=P.groups;for(let H=0,it=q.length;H<it;H++){const G=q[H],Q=W[G.materialIndex];if(Q&&Q.visible){const J=w(C,Q,E,x);C.onBeforeShadow(n,C,A,z,P,J,G),n.renderBufferDirect(z,null,P,J,C,G),C.onAfterShadow(n,C,A,z,P,J,G)}}}else if(W.visible){const q=w(C,W,E,x);C.onBeforeShadow(n,C,A,z,P,q,null),n.renderBufferDirect(z,null,P,q,C,null),C.onAfterShadow(n,C,A,z,P,q,null)}}const j=C.children;for(let P=0,W=j.length;P<W;P++)S(j[P],A,z,E,x)}function N(C){C.target.removeEventListener("dispose",N);for(const z in c){const E=c[z],x=C.target.uuid;x in E&&(E[x].dispose(),delete E[x])}}}function Tv(n){function t(){let _=!1;const L=new ie;let U=null;const K=new ie(0,0,0,0);return{setMask:function(et){U!==et&&!_&&(n.colorMask(et,et,et,et),U=et)},setLocked:function(et){_=et},setClear:function(et,Tt,Ut,se,_e){_e===!0&&(et*=se,Tt*=se,Ut*=se),L.set(et,Tt,Ut,se),K.equals(L)===!1&&(n.clearColor(et,Tt,Ut,se),K.copy(L))},reset:function(){_=!1,U=null,K.set(-1,0,0,0)}}}function e(){let _=!1,L=null,U=null,K=null;return{setTest:function(et){et?ut(n.DEPTH_TEST):rt(n.DEPTH_TEST)},setMask:function(et){L!==et&&!_&&(n.depthMask(et),L=et)},setFunc:function(et){if(U!==et){switch(et){case Ah:n.depthFunc(n.NEVER);break;case Ph:n.depthFunc(n.ALWAYS);break;case Rh:n.depthFunc(n.LESS);break;case ps:n.depthFunc(n.LEQUAL);break;case Lh:n.depthFunc(n.EQUAL);break;case Dh:n.depthFunc(n.GEQUAL);break;case Ih:n.depthFunc(n.GREATER);break;case Uh:n.depthFunc(n.NOTEQUAL);break;default:n.depthFunc(n.LEQUAL)}U=et}},setLocked:function(et){_=et},setClear:function(et){K!==et&&(n.clearDepth(et),K=et)},reset:function(){_=!1,L=null,U=null,K=null}}}function i(){let _=!1,L=null,U=null,K=null,et=null,Tt=null,Ut=null,se=null,_e=null;return{setTest:function(Gt){_||(Gt?ut(n.STENCIL_TEST):rt(n.STENCIL_TEST))},setMask:function(Gt){L!==Gt&&!_&&(n.stencilMask(Gt),L=Gt)},setFunc:function(Gt,ce,Qt){(U!==Gt||K!==ce||et!==Qt)&&(n.stencilFunc(Gt,ce,Qt),U=Gt,K=ce,et=Qt)},setOp:function(Gt,ce,Qt){(Tt!==Gt||Ut!==ce||se!==Qt)&&(n.stencilOp(Gt,ce,Qt),Tt=Gt,Ut=ce,se=Qt)},setLocked:function(Gt){_=Gt},setClear:function(Gt){_e!==Gt&&(n.clearStencil(Gt),_e=Gt)},reset:function(){_=!1,L=null,U=null,K=null,et=null,Tt=null,Ut=null,se=null,_e=null}}}const r=new t,s=new e,o=new i,a=new WeakMap,l=new WeakMap;let c={},u={},h=new WeakMap,p=[],m=null,v=!1,b=null,f=null,d=null,y=null,w=null,S=null,N=null,C=new zt(0,0,0),A=0,z=!1,E=null,x=null,O=null,j=null,P=null;const W=n.getParameter(n.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let q=!1,H=0;const it=n.getParameter(n.VERSION);it.indexOf("WebGL")!==-1?(H=parseFloat(/^WebGL (\d)/.exec(it)[1]),q=H>=1):it.indexOf("OpenGL ES")!==-1&&(H=parseFloat(/^OpenGL ES (\d)/.exec(it)[1]),q=H>=2);let G=null,Q={};const J=n.getParameter(n.SCISSOR_BOX),dt=n.getParameter(n.VIEWPORT),Ot=new ie().fromArray(J),qt=new ie().fromArray(dt);function X(_,L,U,K){const et=new Uint8Array(4),Tt=n.createTexture();n.bindTexture(_,Tt),n.texParameteri(_,n.TEXTURE_MIN_FILTER,n.NEAREST),n.texParameteri(_,n.TEXTURE_MAG_FILTER,n.NEAREST);for(let Ut=0;Ut<U;Ut++)_===n.TEXTURE_3D||_===n.TEXTURE_2D_ARRAY?n.texImage3D(L,0,n.RGBA,1,1,K,0,n.RGBA,n.UNSIGNED_BYTE,et):n.texImage2D(L+Ut,0,n.RGBA,1,1,0,n.RGBA,n.UNSIGNED_BYTE,et);return Tt}const tt={};tt[n.TEXTURE_2D]=X(n.TEXTURE_2D,n.TEXTURE_2D,1),tt[n.TEXTURE_CUBE_MAP]=X(n.TEXTURE_CUBE_MAP,n.TEXTURE_CUBE_MAP_POSITIVE_X,6),tt[n.TEXTURE_2D_ARRAY]=X(n.TEXTURE_2D_ARRAY,n.TEXTURE_2D_ARRAY,1,1),tt[n.TEXTURE_3D]=X(n.TEXTURE_3D,n.TEXTURE_3D,1,1),r.setClear(0,0,0,1),s.setClear(1),o.setClear(0),ut(n.DEPTH_TEST),s.setFunc(ps),Bt(!1),St(Ca),ut(n.CULL_FACE),Kt(Bn);function ut(_){c[_]!==!0&&(n.enable(_),c[_]=!0)}function rt(_){c[_]!==!1&&(n.disable(_),c[_]=!1)}function Ft(_,L){return u[_]!==L?(n.bindFramebuffer(_,L),u[_]=L,_===n.DRAW_FRAMEBUFFER&&(u[n.FRAMEBUFFER]=L),_===n.FRAMEBUFFER&&(u[n.DRAW_FRAMEBUFFER]=L),!0):!1}function Dt(_,L){let U=p,K=!1;if(_){U=h.get(L),U===void 0&&(U=[],h.set(L,U));const et=_.textures;if(U.length!==et.length||U[0]!==n.COLOR_ATTACHMENT0){for(let Tt=0,Ut=et.length;Tt<Ut;Tt++)U[Tt]=n.COLOR_ATTACHMENT0+Tt;U.length=et.length,K=!0}}else U[0]!==n.BACK&&(U[0]=n.BACK,K=!0);K&&n.drawBuffers(U)}function I(_){return m!==_?(n.useProgram(_),m=_,!0):!1}const Yt={[ni]:n.FUNC_ADD,[hh]:n.FUNC_SUBTRACT,[dh]:n.FUNC_REVERSE_SUBTRACT};Yt[ph]=n.MIN,Yt[fh]=n.MAX;const _t={[mh]:n.ZERO,[_h]:n.ONE,[vh]:n.SRC_COLOR,[To]:n.SRC_ALPHA,[Eh]:n.SRC_ALPHA_SATURATE,[Mh]:n.DST_COLOR,[xh]:n.DST_ALPHA,[gh]:n.ONE_MINUS_SRC_COLOR,[Co]:n.ONE_MINUS_SRC_ALPHA,[wh]:n.ONE_MINUS_DST_COLOR,[bh]:n.ONE_MINUS_DST_ALPHA,[Sh]:n.CONSTANT_COLOR,[yh]:n.ONE_MINUS_CONSTANT_COLOR,[Th]:n.CONSTANT_ALPHA,[Ch]:n.ONE_MINUS_CONSTANT_ALPHA};function Kt(_,L,U,K,et,Tt,Ut,se,_e,Gt){if(_===Bn){v===!0&&(rt(n.BLEND),v=!1);return}if(v===!1&&(ut(n.BLEND),v=!0),_!==uh){if(_!==b||Gt!==z){if((f!==ni||w!==ni)&&(n.blendEquation(n.FUNC_ADD),f=ni,w=ni),Gt)switch(_){case Bi:n.blendFuncSeparate(n.ONE,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case Aa:n.blendFunc(n.ONE,n.ONE);break;case Pa:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case Ra:n.blendFuncSeparate(n.ZERO,n.SRC_COLOR,n.ZERO,n.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",_);break}else switch(_){case Bi:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case Aa:n.blendFunc(n.SRC_ALPHA,n.ONE);break;case Pa:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case Ra:n.blendFunc(n.ZERO,n.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",_);break}d=null,y=null,S=null,N=null,C.set(0,0,0),A=0,b=_,z=Gt}return}et=et||L,Tt=Tt||U,Ut=Ut||K,(L!==f||et!==w)&&(n.blendEquationSeparate(Yt[L],Yt[et]),f=L,w=et),(U!==d||K!==y||Tt!==S||Ut!==N)&&(n.blendFuncSeparate(_t[U],_t[K],_t[Tt],_t[Ut]),d=U,y=K,S=Tt,N=Ut),(se.equals(C)===!1||_e!==A)&&(n.blendColor(se.r,se.g,se.b,_e),C.copy(se),A=_e),b=_,z=!1}function gt(_,L){_.side===mn?rt(n.CULL_FACE):ut(n.CULL_FACE);let U=_.side===Pe;L&&(U=!U),Bt(U),_.blending===Bi&&_.transparent===!1?Kt(Bn):Kt(_.blending,_.blendEquation,_.blendSrc,_.blendDst,_.blendEquationAlpha,_.blendSrcAlpha,_.blendDstAlpha,_.blendColor,_.blendAlpha,_.premultipliedAlpha),s.setFunc(_.depthFunc),s.setTest(_.depthTest),s.setMask(_.depthWrite),r.setMask(_.colorWrite);const K=_.stencilWrite;o.setTest(K),K&&(o.setMask(_.stencilWriteMask),o.setFunc(_.stencilFunc,_.stencilRef,_.stencilFuncMask),o.setOp(_.stencilFail,_.stencilZFail,_.stencilZPass)),ee(_.polygonOffset,_.polygonOffsetFactor,_.polygonOffsetUnits),_.alphaToCoverage===!0?ut(n.SAMPLE_ALPHA_TO_COVERAGE):rt(n.SAMPLE_ALPHA_TO_COVERAGE)}function Bt(_){E!==_&&(_?n.frontFace(n.CW):n.frontFace(n.CCW),E=_)}function St(_){_!==ah?(ut(n.CULL_FACE),_!==x&&(_===Ca?n.cullFace(n.BACK):_===lh?n.cullFace(n.FRONT):n.cullFace(n.FRONT_AND_BACK))):rt(n.CULL_FACE),x=_}function kt(_){_!==O&&(q&&n.lineWidth(_),O=_)}function ee(_,L,U){_?(ut(n.POLYGON_OFFSET_FILL),(j!==L||P!==U)&&(n.polygonOffset(L,U),j=L,P=U)):rt(n.POLYGON_OFFSET_FILL)}function T(_){_?ut(n.SCISSOR_TEST):rt(n.SCISSOR_TEST)}function g(_){_===void 0&&(_=n.TEXTURE0+W-1),G!==_&&(n.activeTexture(_),G=_)}function V(_,L,U){U===void 0&&(G===null?U=n.TEXTURE0+W-1:U=G);let K=Q[U];K===void 0&&(K={type:void 0,texture:void 0},Q[U]=K),(K.type!==_||K.texture!==L)&&(G!==U&&(n.activeTexture(U),G=U),n.bindTexture(_,L||tt[_]),K.type=_,K.texture=L)}function Y(){const _=Q[G];_!==void 0&&_.type!==void 0&&(n.bindTexture(_.type,null),_.type=void 0,_.texture=void 0)}function $(){try{n.compressedTexImage2D.apply(n,arguments)}catch(_){console.error("THREE.WebGLState:",_)}}function Z(){try{n.compressedTexImage3D.apply(n,arguments)}catch(_){console.error("THREE.WebGLState:",_)}}function mt(){try{n.texSubImage2D.apply(n,arguments)}catch(_){console.error("THREE.WebGLState:",_)}}function at(){try{n.texSubImage3D.apply(n,arguments)}catch(_){console.error("THREE.WebGLState:",_)}}function ot(){try{n.compressedTexSubImage2D.apply(n,arguments)}catch(_){console.error("THREE.WebGLState:",_)}}function Mt(){try{n.compressedTexSubImage3D.apply(n,arguments)}catch(_){console.error("THREE.WebGLState:",_)}}function nt(){try{n.texStorage2D.apply(n,arguments)}catch(_){console.error("THREE.WebGLState:",_)}}function ft(){try{n.texStorage3D.apply(n,arguments)}catch(_){console.error("THREE.WebGLState:",_)}}function Vt(){try{n.texImage2D.apply(n,arguments)}catch(_){console.error("THREE.WebGLState:",_)}}function vt(){try{n.texImage3D.apply(n,arguments)}catch(_){console.error("THREE.WebGLState:",_)}}function ct(_){Ot.equals(_)===!1&&(n.scissor(_.x,_.y,_.z,_.w),Ot.copy(_))}function yt(_){qt.equals(_)===!1&&(n.viewport(_.x,_.y,_.z,_.w),qt.copy(_))}function It(_,L){let U=l.get(L);U===void 0&&(U=new WeakMap,l.set(L,U));let K=U.get(_);K===void 0&&(K=n.getUniformBlockIndex(L,_.name),U.set(_,K))}function $t(_,L){const K=l.get(L).get(_);a.get(L)!==K&&(n.uniformBlockBinding(L,K,_.__bindingPointIndex),a.set(L,K))}function Ct(){n.disable(n.BLEND),n.disable(n.CULL_FACE),n.disable(n.DEPTH_TEST),n.disable(n.POLYGON_OFFSET_FILL),n.disable(n.SCISSOR_TEST),n.disable(n.STENCIL_TEST),n.disable(n.SAMPLE_ALPHA_TO_COVERAGE),n.blendEquation(n.FUNC_ADD),n.blendFunc(n.ONE,n.ZERO),n.blendFuncSeparate(n.ONE,n.ZERO,n.ONE,n.ZERO),n.blendColor(0,0,0,0),n.colorMask(!0,!0,!0,!0),n.clearColor(0,0,0,0),n.depthMask(!0),n.depthFunc(n.LESS),n.clearDepth(1),n.stencilMask(4294967295),n.stencilFunc(n.ALWAYS,0,4294967295),n.stencilOp(n.KEEP,n.KEEP,n.KEEP),n.clearStencil(0),n.cullFace(n.BACK),n.frontFace(n.CCW),n.polygonOffset(0,0),n.activeTexture(n.TEXTURE0),n.bindFramebuffer(n.FRAMEBUFFER,null),n.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),n.bindFramebuffer(n.READ_FRAMEBUFFER,null),n.useProgram(null),n.lineWidth(1),n.scissor(0,0,n.canvas.width,n.canvas.height),n.viewport(0,0,n.canvas.width,n.canvas.height),c={},G=null,Q={},u={},h=new WeakMap,p=[],m=null,v=!1,b=null,f=null,d=null,y=null,w=null,S=null,N=null,C=new zt(0,0,0),A=0,z=!1,E=null,x=null,O=null,j=null,P=null,Ot.set(0,0,n.canvas.width,n.canvas.height),qt.set(0,0,n.canvas.width,n.canvas.height),r.reset(),s.reset(),o.reset()}return{buffers:{color:r,depth:s,stencil:o},enable:ut,disable:rt,bindFramebuffer:Ft,drawBuffers:Dt,useProgram:I,setBlending:Kt,setMaterial:gt,setFlipSided:Bt,setCullFace:St,setLineWidth:kt,setPolygonOffset:ee,setScissorTest:T,activeTexture:g,bindTexture:V,unbindTexture:Y,compressedTexImage2D:$,compressedTexImage3D:Z,texImage2D:Vt,texImage3D:vt,updateUBOMapping:It,uniformBlockBinding:$t,texStorage2D:nt,texStorage3D:ft,texSubImage2D:mt,texSubImage3D:at,compressedTexSubImage2D:ot,compressedTexSubImage3D:Mt,scissor:ct,viewport:yt,reset:Ct}}function Cv(n,t,e,i,r,s,o){const a=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new bt,u=new WeakMap;let h;const p=new WeakMap;let m=!1;try{m=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function v(T,g){return m?new OffscreenCanvas(T,g):gr("canvas")}function b(T,g,V){let Y=1;const $=ee(T);if(($.width>V||$.height>V)&&(Y=V/Math.max($.width,$.height)),Y<1)if(typeof HTMLImageElement<"u"&&T instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&T instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&T instanceof ImageBitmap||typeof VideoFrame<"u"&&T instanceof VideoFrame){const Z=Math.floor(Y*$.width),mt=Math.floor(Y*$.height);h===void 0&&(h=v(Z,mt));const at=g?v(Z,mt):h;return at.width=Z,at.height=mt,at.getContext("2d").drawImage(T,0,0,Z,mt),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+$.width+"x"+$.height+") to ("+Z+"x"+mt+")."),at}else return"data"in T&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+$.width+"x"+$.height+")."),T;return T}function f(T){return T.generateMipmaps&&T.minFilter!==Ge&&T.minFilter!==Ye}function d(T){n.generateMipmap(T)}function y(T,g,V,Y,$=!1){if(T!==null){if(n[T]!==void 0)return n[T];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+T+"'")}let Z=g;if(g===n.RED&&(V===n.FLOAT&&(Z=n.R32F),V===n.HALF_FLOAT&&(Z=n.R16F),V===n.UNSIGNED_BYTE&&(Z=n.R8)),g===n.RED_INTEGER&&(V===n.UNSIGNED_BYTE&&(Z=n.R8UI),V===n.UNSIGNED_SHORT&&(Z=n.R16UI),V===n.UNSIGNED_INT&&(Z=n.R32UI),V===n.BYTE&&(Z=n.R8I),V===n.SHORT&&(Z=n.R16I),V===n.INT&&(Z=n.R32I)),g===n.RG&&(V===n.FLOAT&&(Z=n.RG32F),V===n.HALF_FLOAT&&(Z=n.RG16F),V===n.UNSIGNED_BYTE&&(Z=n.RG8)),g===n.RG_INTEGER&&(V===n.UNSIGNED_BYTE&&(Z=n.RG8UI),V===n.UNSIGNED_SHORT&&(Z=n.RG16UI),V===n.UNSIGNED_INT&&(Z=n.RG32UI),V===n.BYTE&&(Z=n.RG8I),V===n.SHORT&&(Z=n.RG16I),V===n.INT&&(Z=n.RG32I)),g===n.RGB&&V===n.UNSIGNED_INT_5_9_9_9_REV&&(Z=n.RGB9_E5),g===n.RGBA){const mt=$?fs:Zt.getTransfer(Y);V===n.FLOAT&&(Z=n.RGBA32F),V===n.HALF_FLOAT&&(Z=n.RGBA16F),V===n.UNSIGNED_BYTE&&(Z=mt===te?n.SRGB8_ALPHA8:n.RGBA8),V===n.UNSIGNED_SHORT_4_4_4_4&&(Z=n.RGBA4),V===n.UNSIGNED_SHORT_5_5_5_1&&(Z=n.RGB5_A1)}return(Z===n.R16F||Z===n.R32F||Z===n.RG16F||Z===n.RG32F||Z===n.RGBA16F||Z===n.RGBA32F)&&t.get("EXT_color_buffer_float"),Z}function w(T,g){return f(T)===!0||T.isFramebufferTexture&&T.minFilter!==Ge&&T.minFilter!==Ye?Math.log2(Math.max(g.width,g.height))+1:T.mipmaps!==void 0&&T.mipmaps.length>0?T.mipmaps.length:T.isCompressedTexture&&Array.isArray(T.image)?g.mipmaps.length:1}function S(T){const g=T.target;g.removeEventListener("dispose",S),C(g),g.isVideoTexture&&u.delete(g)}function N(T){const g=T.target;g.removeEventListener("dispose",N),z(g)}function C(T){const g=i.get(T);if(g.__webglInit===void 0)return;const V=T.source,Y=p.get(V);if(Y){const $=Y[g.__cacheKey];$.usedTimes--,$.usedTimes===0&&A(T),Object.keys(Y).length===0&&p.delete(V)}i.remove(T)}function A(T){const g=i.get(T);n.deleteTexture(g.__webglTexture);const V=T.source,Y=p.get(V);delete Y[g.__cacheKey],o.memory.textures--}function z(T){const g=i.get(T);if(T.depthTexture&&T.depthTexture.dispose(),T.isWebGLCubeRenderTarget)for(let Y=0;Y<6;Y++){if(Array.isArray(g.__webglFramebuffer[Y]))for(let $=0;$<g.__webglFramebuffer[Y].length;$++)n.deleteFramebuffer(g.__webglFramebuffer[Y][$]);else n.deleteFramebuffer(g.__webglFramebuffer[Y]);g.__webglDepthbuffer&&n.deleteRenderbuffer(g.__webglDepthbuffer[Y])}else{if(Array.isArray(g.__webglFramebuffer))for(let Y=0;Y<g.__webglFramebuffer.length;Y++)n.deleteFramebuffer(g.__webglFramebuffer[Y]);else n.deleteFramebuffer(g.__webglFramebuffer);if(g.__webglDepthbuffer&&n.deleteRenderbuffer(g.__webglDepthbuffer),g.__webglMultisampledFramebuffer&&n.deleteFramebuffer(g.__webglMultisampledFramebuffer),g.__webglColorRenderbuffer)for(let Y=0;Y<g.__webglColorRenderbuffer.length;Y++)g.__webglColorRenderbuffer[Y]&&n.deleteRenderbuffer(g.__webglColorRenderbuffer[Y]);g.__webglDepthRenderbuffer&&n.deleteRenderbuffer(g.__webglDepthRenderbuffer)}const V=T.textures;for(let Y=0,$=V.length;Y<$;Y++){const Z=i.get(V[Y]);Z.__webglTexture&&(n.deleteTexture(Z.__webglTexture),o.memory.textures--),i.remove(V[Y])}i.remove(T)}let E=0;function x(){E=0}function O(){const T=E;return T>=r.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+T+" texture units while this GPU supports only "+r.maxTextures),E+=1,T}function j(T){const g=[];return g.push(T.wrapS),g.push(T.wrapT),g.push(T.wrapR||0),g.push(T.magFilter),g.push(T.minFilter),g.push(T.anisotropy),g.push(T.internalFormat),g.push(T.format),g.push(T.type),g.push(T.generateMipmaps),g.push(T.premultiplyAlpha),g.push(T.flipY),g.push(T.unpackAlignment),g.push(T.colorSpace),g.join()}function P(T,g){const V=i.get(T);if(T.isVideoTexture&&St(T),T.isRenderTargetTexture===!1&&T.version>0&&V.__version!==T.version){const Y=T.image;if(Y===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(Y.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{Ot(V,T,g);return}}e.bindTexture(n.TEXTURE_2D,V.__webglTexture,n.TEXTURE0+g)}function W(T,g){const V=i.get(T);if(T.version>0&&V.__version!==T.version){Ot(V,T,g);return}e.bindTexture(n.TEXTURE_2D_ARRAY,V.__webglTexture,n.TEXTURE0+g)}function q(T,g){const V=i.get(T);if(T.version>0&&V.__version!==T.version){Ot(V,T,g);return}e.bindTexture(n.TEXTURE_3D,V.__webglTexture,n.TEXTURE0+g)}function H(T,g){const V=i.get(T);if(T.version>0&&V.__version!==T.version){qt(V,T,g);return}e.bindTexture(n.TEXTURE_CUBE_MAP,V.__webglTexture,n.TEXTURE0+g)}const it={[Ro]:n.REPEAT,[ri]:n.CLAMP_TO_EDGE,[Lo]:n.MIRRORED_REPEAT},G={[Ge]:n.NEAREST,[Wh]:n.NEAREST_MIPMAP_NEAREST,[kr]:n.NEAREST_MIPMAP_LINEAR,[Ye]:n.LINEAR,[Os]:n.LINEAR_MIPMAP_NEAREST,[si]:n.LINEAR_MIPMAP_LINEAR},Q={[rd]:n.NEVER,[ud]:n.ALWAYS,[sd]:n.LESS,[Oc]:n.LEQUAL,[od]:n.EQUAL,[cd]:n.GEQUAL,[ad]:n.GREATER,[ld]:n.NOTEQUAL};function J(T,g){if(g.type===On&&t.has("OES_texture_float_linear")===!1&&(g.magFilter===Ye||g.magFilter===Os||g.magFilter===kr||g.magFilter===si||g.minFilter===Ye||g.minFilter===Os||g.minFilter===kr||g.minFilter===si)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),n.texParameteri(T,n.TEXTURE_WRAP_S,it[g.wrapS]),n.texParameteri(T,n.TEXTURE_WRAP_T,it[g.wrapT]),(T===n.TEXTURE_3D||T===n.TEXTURE_2D_ARRAY)&&n.texParameteri(T,n.TEXTURE_WRAP_R,it[g.wrapR]),n.texParameteri(T,n.TEXTURE_MAG_FILTER,G[g.magFilter]),n.texParameteri(T,n.TEXTURE_MIN_FILTER,G[g.minFilter]),g.compareFunction&&(n.texParameteri(T,n.TEXTURE_COMPARE_MODE,n.COMPARE_REF_TO_TEXTURE),n.texParameteri(T,n.TEXTURE_COMPARE_FUNC,Q[g.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(g.magFilter===Ge||g.minFilter!==kr&&g.minFilter!==si||g.type===On&&t.has("OES_texture_float_linear")===!1)return;if(g.anisotropy>1||i.get(g).__currentAnisotropy){const V=t.get("EXT_texture_filter_anisotropic");n.texParameterf(T,V.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(g.anisotropy,r.getMaxAnisotropy())),i.get(g).__currentAnisotropy=g.anisotropy}}}function dt(T,g){let V=!1;T.__webglInit===void 0&&(T.__webglInit=!0,g.addEventListener("dispose",S));const Y=g.source;let $=p.get(Y);$===void 0&&($={},p.set(Y,$));const Z=j(g);if(Z!==T.__cacheKey){$[Z]===void 0&&($[Z]={texture:n.createTexture(),usedTimes:0},o.memory.textures++,V=!0),$[Z].usedTimes++;const mt=$[T.__cacheKey];mt!==void 0&&($[T.__cacheKey].usedTimes--,mt.usedTimes===0&&A(g)),T.__cacheKey=Z,T.__webglTexture=$[Z].texture}return V}function Ot(T,g,V){let Y=n.TEXTURE_2D;(g.isDataArrayTexture||g.isCompressedArrayTexture)&&(Y=n.TEXTURE_2D_ARRAY),g.isData3DTexture&&(Y=n.TEXTURE_3D);const $=dt(T,g),Z=g.source;e.bindTexture(Y,T.__webglTexture,n.TEXTURE0+V);const mt=i.get(Z);if(Z.version!==mt.__version||$===!0){e.activeTexture(n.TEXTURE0+V);const at=Zt.getPrimaries(Zt.workingColorSpace),ot=g.colorSpace===Nn?null:Zt.getPrimaries(g.colorSpace),Mt=g.colorSpace===Nn||at===ot?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,g.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,g.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,Mt);let nt=b(g.image,!1,r.maxTextureSize);nt=kt(g,nt);const ft=s.convert(g.format,g.colorSpace),Vt=s.convert(g.type);let vt=y(g.internalFormat,ft,Vt,g.colorSpace,g.isVideoTexture);J(Y,g);let ct;const yt=g.mipmaps,It=g.isVideoTexture!==!0,$t=mt.__version===void 0||$===!0,Ct=Z.dataReady,_=w(g,nt);if(g.isDepthTexture)vt=n.DEPTH_COMPONENT16,g.type===On?vt=n.DEPTH_COMPONENT32F:g.type===Xi?vt=n.DEPTH_COMPONENT24:g.type===yr&&(vt=n.DEPTH24_STENCIL8),$t&&(It?e.texStorage2D(n.TEXTURE_2D,1,vt,nt.width,nt.height):e.texImage2D(n.TEXTURE_2D,0,vt,nt.width,nt.height,0,ft,Vt,null));else if(g.isDataTexture)if(yt.length>0){It&&$t&&e.texStorage2D(n.TEXTURE_2D,_,vt,yt[0].width,yt[0].height);for(let L=0,U=yt.length;L<U;L++)ct=yt[L],It?Ct&&e.texSubImage2D(n.TEXTURE_2D,L,0,0,ct.width,ct.height,ft,Vt,ct.data):e.texImage2D(n.TEXTURE_2D,L,vt,ct.width,ct.height,0,ft,Vt,ct.data);g.generateMipmaps=!1}else It?($t&&e.texStorage2D(n.TEXTURE_2D,_,vt,nt.width,nt.height),Ct&&e.texSubImage2D(n.TEXTURE_2D,0,0,0,nt.width,nt.height,ft,Vt,nt.data)):e.texImage2D(n.TEXTURE_2D,0,vt,nt.width,nt.height,0,ft,Vt,nt.data);else if(g.isCompressedTexture)if(g.isCompressedArrayTexture){It&&$t&&e.texStorage3D(n.TEXTURE_2D_ARRAY,_,vt,yt[0].width,yt[0].height,nt.depth);for(let L=0,U=yt.length;L<U;L++)ct=yt[L],g.format!==Qe?ft!==null?It?Ct&&e.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,L,0,0,0,ct.width,ct.height,nt.depth,ft,ct.data,0,0):e.compressedTexImage3D(n.TEXTURE_2D_ARRAY,L,vt,ct.width,ct.height,nt.depth,0,ct.data,0,0):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):It?Ct&&e.texSubImage3D(n.TEXTURE_2D_ARRAY,L,0,0,0,ct.width,ct.height,nt.depth,ft,Vt,ct.data):e.texImage3D(n.TEXTURE_2D_ARRAY,L,vt,ct.width,ct.height,nt.depth,0,ft,Vt,ct.data)}else{It&&$t&&e.texStorage2D(n.TEXTURE_2D,_,vt,yt[0].width,yt[0].height);for(let L=0,U=yt.length;L<U;L++)ct=yt[L],g.format!==Qe?ft!==null?It?Ct&&e.compressedTexSubImage2D(n.TEXTURE_2D,L,0,0,ct.width,ct.height,ft,ct.data):e.compressedTexImage2D(n.TEXTURE_2D,L,vt,ct.width,ct.height,0,ct.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):It?Ct&&e.texSubImage2D(n.TEXTURE_2D,L,0,0,ct.width,ct.height,ft,Vt,ct.data):e.texImage2D(n.TEXTURE_2D,L,vt,ct.width,ct.height,0,ft,Vt,ct.data)}else if(g.isDataArrayTexture)It?($t&&e.texStorage3D(n.TEXTURE_2D_ARRAY,_,vt,nt.width,nt.height,nt.depth),Ct&&e.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,0,nt.width,nt.height,nt.depth,ft,Vt,nt.data)):e.texImage3D(n.TEXTURE_2D_ARRAY,0,vt,nt.width,nt.height,nt.depth,0,ft,Vt,nt.data);else if(g.isData3DTexture)It?($t&&e.texStorage3D(n.TEXTURE_3D,_,vt,nt.width,nt.height,nt.depth),Ct&&e.texSubImage3D(n.TEXTURE_3D,0,0,0,0,nt.width,nt.height,nt.depth,ft,Vt,nt.data)):e.texImage3D(n.TEXTURE_3D,0,vt,nt.width,nt.height,nt.depth,0,ft,Vt,nt.data);else if(g.isFramebufferTexture){if($t)if(It)e.texStorage2D(n.TEXTURE_2D,_,vt,nt.width,nt.height);else{let L=nt.width,U=nt.height;for(let K=0;K<_;K++)e.texImage2D(n.TEXTURE_2D,K,vt,L,U,0,ft,Vt,null),L>>=1,U>>=1}}else if(yt.length>0){if(It&&$t){const L=ee(yt[0]);e.texStorage2D(n.TEXTURE_2D,_,vt,L.width,L.height)}for(let L=0,U=yt.length;L<U;L++)ct=yt[L],It?Ct&&e.texSubImage2D(n.TEXTURE_2D,L,0,0,ft,Vt,ct):e.texImage2D(n.TEXTURE_2D,L,vt,ft,Vt,ct);g.generateMipmaps=!1}else if(It){if($t){const L=ee(nt);e.texStorage2D(n.TEXTURE_2D,_,vt,L.width,L.height)}Ct&&e.texSubImage2D(n.TEXTURE_2D,0,0,0,ft,Vt,nt)}else e.texImage2D(n.TEXTURE_2D,0,vt,ft,Vt,nt);f(g)&&d(Y),mt.__version=Z.version,g.onUpdate&&g.onUpdate(g)}T.__version=g.version}function qt(T,g,V){if(g.image.length!==6)return;const Y=dt(T,g),$=g.source;e.bindTexture(n.TEXTURE_CUBE_MAP,T.__webglTexture,n.TEXTURE0+V);const Z=i.get($);if($.version!==Z.__version||Y===!0){e.activeTexture(n.TEXTURE0+V);const mt=Zt.getPrimaries(Zt.workingColorSpace),at=g.colorSpace===Nn?null:Zt.getPrimaries(g.colorSpace),ot=g.colorSpace===Nn||mt===at?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,g.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,g.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,ot);const Mt=g.isCompressedTexture||g.image[0].isCompressedTexture,nt=g.image[0]&&g.image[0].isDataTexture,ft=[];for(let U=0;U<6;U++)!Mt&&!nt?ft[U]=b(g.image[U],!0,r.maxCubemapSize):ft[U]=nt?g.image[U].image:g.image[U],ft[U]=kt(g,ft[U]);const Vt=ft[0],vt=s.convert(g.format,g.colorSpace),ct=s.convert(g.type),yt=y(g.internalFormat,vt,ct,g.colorSpace),It=g.isVideoTexture!==!0,$t=Z.__version===void 0||Y===!0,Ct=$.dataReady;let _=w(g,Vt);J(n.TEXTURE_CUBE_MAP,g);let L;if(Mt){It&&$t&&e.texStorage2D(n.TEXTURE_CUBE_MAP,_,yt,Vt.width,Vt.height);for(let U=0;U<6;U++){L=ft[U].mipmaps;for(let K=0;K<L.length;K++){const et=L[K];g.format!==Qe?vt!==null?It?Ct&&e.compressedTexSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+U,K,0,0,et.width,et.height,vt,et.data):e.compressedTexImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+U,K,yt,et.width,et.height,0,et.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):It?Ct&&e.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+U,K,0,0,et.width,et.height,vt,ct,et.data):e.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+U,K,yt,et.width,et.height,0,vt,ct,et.data)}}}else{if(L=g.mipmaps,It&&$t){L.length>0&&_++;const U=ee(ft[0]);e.texStorage2D(n.TEXTURE_CUBE_MAP,_,yt,U.width,U.height)}for(let U=0;U<6;U++)if(nt){It?Ct&&e.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+U,0,0,0,ft[U].width,ft[U].height,vt,ct,ft[U].data):e.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+U,0,yt,ft[U].width,ft[U].height,0,vt,ct,ft[U].data);for(let K=0;K<L.length;K++){const Tt=L[K].image[U].image;It?Ct&&e.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+U,K+1,0,0,Tt.width,Tt.height,vt,ct,Tt.data):e.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+U,K+1,yt,Tt.width,Tt.height,0,vt,ct,Tt.data)}}else{It?Ct&&e.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+U,0,0,0,vt,ct,ft[U]):e.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+U,0,yt,vt,ct,ft[U]);for(let K=0;K<L.length;K++){const et=L[K];It?Ct&&e.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+U,K+1,0,0,vt,ct,et.image[U]):e.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+U,K+1,yt,vt,ct,et.image[U])}}}f(g)&&d(n.TEXTURE_CUBE_MAP),Z.__version=$.version,g.onUpdate&&g.onUpdate(g)}T.__version=g.version}function X(T,g,V,Y,$,Z){const mt=s.convert(V.format,V.colorSpace),at=s.convert(V.type),ot=y(V.internalFormat,mt,at,V.colorSpace);if(!i.get(g).__hasExternalTextures){const nt=Math.max(1,g.width>>Z),ft=Math.max(1,g.height>>Z);$===n.TEXTURE_3D||$===n.TEXTURE_2D_ARRAY?e.texImage3D($,Z,ot,nt,ft,g.depth,0,mt,at,null):e.texImage2D($,Z,ot,nt,ft,0,mt,at,null)}e.bindFramebuffer(n.FRAMEBUFFER,T),Bt(g)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,Y,$,i.get(V).__webglTexture,0,gt(g)):($===n.TEXTURE_2D||$>=n.TEXTURE_CUBE_MAP_POSITIVE_X&&$<=n.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&n.framebufferTexture2D(n.FRAMEBUFFER,Y,$,i.get(V).__webglTexture,Z),e.bindFramebuffer(n.FRAMEBUFFER,null)}function tt(T,g,V){if(n.bindRenderbuffer(n.RENDERBUFFER,T),g.depthBuffer&&!g.stencilBuffer){let Y=n.DEPTH_COMPONENT24;if(V||Bt(g)){const $=g.depthTexture;$&&$.isDepthTexture&&($.type===On?Y=n.DEPTH_COMPONENT32F:$.type===Xi&&(Y=n.DEPTH_COMPONENT24));const Z=gt(g);Bt(g)?a.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,Z,Y,g.width,g.height):n.renderbufferStorageMultisample(n.RENDERBUFFER,Z,Y,g.width,g.height)}else n.renderbufferStorage(n.RENDERBUFFER,Y,g.width,g.height);n.framebufferRenderbuffer(n.FRAMEBUFFER,n.DEPTH_ATTACHMENT,n.RENDERBUFFER,T)}else if(g.depthBuffer&&g.stencilBuffer){const Y=gt(g);V&&Bt(g)===!1?n.renderbufferStorageMultisample(n.RENDERBUFFER,Y,n.DEPTH24_STENCIL8,g.width,g.height):Bt(g)?a.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,Y,n.DEPTH24_STENCIL8,g.width,g.height):n.renderbufferStorage(n.RENDERBUFFER,n.DEPTH_STENCIL,g.width,g.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.DEPTH_STENCIL_ATTACHMENT,n.RENDERBUFFER,T)}else{const Y=g.textures;for(let $=0;$<Y.length;$++){const Z=Y[$],mt=s.convert(Z.format,Z.colorSpace),at=s.convert(Z.type),ot=y(Z.internalFormat,mt,at,Z.colorSpace),Mt=gt(g);V&&Bt(g)===!1?n.renderbufferStorageMultisample(n.RENDERBUFFER,Mt,ot,g.width,g.height):Bt(g)?a.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,Mt,ot,g.width,g.height):n.renderbufferStorage(n.RENDERBUFFER,ot,g.width,g.height)}}n.bindRenderbuffer(n.RENDERBUFFER,null)}function ut(T,g){if(g&&g.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(e.bindFramebuffer(n.FRAMEBUFFER,T),!(g.depthTexture&&g.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");(!i.get(g.depthTexture).__webglTexture||g.depthTexture.image.width!==g.width||g.depthTexture.image.height!==g.height)&&(g.depthTexture.image.width=g.width,g.depthTexture.image.height=g.height,g.depthTexture.needsUpdate=!0),P(g.depthTexture,0);const Y=i.get(g.depthTexture).__webglTexture,$=gt(g);if(g.depthTexture.format===ki)Bt(g)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,n.DEPTH_ATTACHMENT,n.TEXTURE_2D,Y,0,$):n.framebufferTexture2D(n.FRAMEBUFFER,n.DEPTH_ATTACHMENT,n.TEXTURE_2D,Y,0);else if(g.depthTexture.format===_r)Bt(g)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,n.DEPTH_STENCIL_ATTACHMENT,n.TEXTURE_2D,Y,0,$):n.framebufferTexture2D(n.FRAMEBUFFER,n.DEPTH_STENCIL_ATTACHMENT,n.TEXTURE_2D,Y,0);else throw new Error("Unknown depthTexture format")}function rt(T){const g=i.get(T),V=T.isWebGLCubeRenderTarget===!0;if(T.depthTexture&&!g.__autoAllocateDepthBuffer){if(V)throw new Error("target.depthTexture not supported in Cube render targets");ut(g.__webglFramebuffer,T)}else if(V){g.__webglDepthbuffer=[];for(let Y=0;Y<6;Y++)e.bindFramebuffer(n.FRAMEBUFFER,g.__webglFramebuffer[Y]),g.__webglDepthbuffer[Y]=n.createRenderbuffer(),tt(g.__webglDepthbuffer[Y],T,!1)}else e.bindFramebuffer(n.FRAMEBUFFER,g.__webglFramebuffer),g.__webglDepthbuffer=n.createRenderbuffer(),tt(g.__webglDepthbuffer,T,!1);e.bindFramebuffer(n.FRAMEBUFFER,null)}function Ft(T,g,V){const Y=i.get(T);g!==void 0&&X(Y.__webglFramebuffer,T,T.texture,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,0),V!==void 0&&rt(T)}function Dt(T){const g=T.texture,V=i.get(T),Y=i.get(g);T.addEventListener("dispose",N);const $=T.textures,Z=T.isWebGLCubeRenderTarget===!0,mt=$.length>1;if(mt||(Y.__webglTexture===void 0&&(Y.__webglTexture=n.createTexture()),Y.__version=g.version,o.memory.textures++),Z){V.__webglFramebuffer=[];for(let at=0;at<6;at++)if(g.mipmaps&&g.mipmaps.length>0){V.__webglFramebuffer[at]=[];for(let ot=0;ot<g.mipmaps.length;ot++)V.__webglFramebuffer[at][ot]=n.createFramebuffer()}else V.__webglFramebuffer[at]=n.createFramebuffer()}else{if(g.mipmaps&&g.mipmaps.length>0){V.__webglFramebuffer=[];for(let at=0;at<g.mipmaps.length;at++)V.__webglFramebuffer[at]=n.createFramebuffer()}else V.__webglFramebuffer=n.createFramebuffer();if(mt)for(let at=0,ot=$.length;at<ot;at++){const Mt=i.get($[at]);Mt.__webglTexture===void 0&&(Mt.__webglTexture=n.createTexture(),o.memory.textures++)}if(T.samples>0&&Bt(T)===!1){V.__webglMultisampledFramebuffer=n.createFramebuffer(),V.__webglColorRenderbuffer=[],e.bindFramebuffer(n.FRAMEBUFFER,V.__webglMultisampledFramebuffer);for(let at=0;at<$.length;at++){const ot=$[at];V.__webglColorRenderbuffer[at]=n.createRenderbuffer(),n.bindRenderbuffer(n.RENDERBUFFER,V.__webglColorRenderbuffer[at]);const Mt=s.convert(ot.format,ot.colorSpace),nt=s.convert(ot.type),ft=y(ot.internalFormat,Mt,nt,ot.colorSpace,T.isXRRenderTarget===!0),Vt=gt(T);n.renderbufferStorageMultisample(n.RENDERBUFFER,Vt,ft,T.width,T.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+at,n.RENDERBUFFER,V.__webglColorRenderbuffer[at])}n.bindRenderbuffer(n.RENDERBUFFER,null),T.depthBuffer&&(V.__webglDepthRenderbuffer=n.createRenderbuffer(),tt(V.__webglDepthRenderbuffer,T,!0)),e.bindFramebuffer(n.FRAMEBUFFER,null)}}if(Z){e.bindTexture(n.TEXTURE_CUBE_MAP,Y.__webglTexture),J(n.TEXTURE_CUBE_MAP,g);for(let at=0;at<6;at++)if(g.mipmaps&&g.mipmaps.length>0)for(let ot=0;ot<g.mipmaps.length;ot++)X(V.__webglFramebuffer[at][ot],T,g,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+at,ot);else X(V.__webglFramebuffer[at],T,g,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+at,0);f(g)&&d(n.TEXTURE_CUBE_MAP),e.unbindTexture()}else if(mt){for(let at=0,ot=$.length;at<ot;at++){const Mt=$[at],nt=i.get(Mt);e.bindTexture(n.TEXTURE_2D,nt.__webglTexture),J(n.TEXTURE_2D,Mt),X(V.__webglFramebuffer,T,Mt,n.COLOR_ATTACHMENT0+at,n.TEXTURE_2D,0),f(Mt)&&d(n.TEXTURE_2D)}e.unbindTexture()}else{let at=n.TEXTURE_2D;if((T.isWebGL3DRenderTarget||T.isWebGLArrayRenderTarget)&&(at=T.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),e.bindTexture(at,Y.__webglTexture),J(at,g),g.mipmaps&&g.mipmaps.length>0)for(let ot=0;ot<g.mipmaps.length;ot++)X(V.__webglFramebuffer[ot],T,g,n.COLOR_ATTACHMENT0,at,ot);else X(V.__webglFramebuffer,T,g,n.COLOR_ATTACHMENT0,at,0);f(g)&&d(at),e.unbindTexture()}T.depthBuffer&&rt(T)}function I(T){const g=T.textures;for(let V=0,Y=g.length;V<Y;V++){const $=g[V];if(f($)){const Z=T.isWebGLCubeRenderTarget?n.TEXTURE_CUBE_MAP:n.TEXTURE_2D,mt=i.get($).__webglTexture;e.bindTexture(Z,mt),d(Z),e.unbindTexture()}}}const Yt=[],_t=[];function Kt(T){if(T.samples>0){if(Bt(T)===!1){const g=T.textures,V=T.width,Y=T.height;let $=n.COLOR_BUFFER_BIT;const Z=T.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,mt=i.get(T),at=g.length>1;if(at)for(let ot=0;ot<g.length;ot++)e.bindFramebuffer(n.FRAMEBUFFER,mt.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+ot,n.RENDERBUFFER,null),e.bindFramebuffer(n.FRAMEBUFFER,mt.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+ot,n.TEXTURE_2D,null,0);e.bindFramebuffer(n.READ_FRAMEBUFFER,mt.__webglMultisampledFramebuffer),e.bindFramebuffer(n.DRAW_FRAMEBUFFER,mt.__webglFramebuffer);for(let ot=0;ot<g.length;ot++){if(T.resolveDepthBuffer&&(T.depthBuffer&&($|=n.DEPTH_BUFFER_BIT),T.stencilBuffer&&T.resolveStencilBuffer&&($|=n.STENCIL_BUFFER_BIT)),at){n.framebufferRenderbuffer(n.READ_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.RENDERBUFFER,mt.__webglColorRenderbuffer[ot]);const Mt=i.get(g[ot]).__webglTexture;n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,Mt,0)}n.blitFramebuffer(0,0,V,Y,0,0,V,Y,$,n.NEAREST),l===!0&&(Yt.length=0,_t.length=0,Yt.push(n.COLOR_ATTACHMENT0+ot),T.depthBuffer&&T.resolveDepthBuffer===!1&&(Yt.push(Z),_t.push(Z),n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,_t)),n.invalidateFramebuffer(n.READ_FRAMEBUFFER,Yt))}if(e.bindFramebuffer(n.READ_FRAMEBUFFER,null),e.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),at)for(let ot=0;ot<g.length;ot++){e.bindFramebuffer(n.FRAMEBUFFER,mt.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+ot,n.RENDERBUFFER,mt.__webglColorRenderbuffer[ot]);const Mt=i.get(g[ot]).__webglTexture;e.bindFramebuffer(n.FRAMEBUFFER,mt.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+ot,n.TEXTURE_2D,Mt,0)}e.bindFramebuffer(n.DRAW_FRAMEBUFFER,mt.__webglMultisampledFramebuffer)}else if(T.depthBuffer&&T.resolveDepthBuffer===!1&&l){const g=T.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,[g])}}}function gt(T){return Math.min(r.maxSamples,T.samples)}function Bt(T){const g=i.get(T);return T.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&g.__useRenderToTexture!==!1}function St(T){const g=o.render.frame;u.get(T)!==g&&(u.set(T,g),T.update())}function kt(T,g){const V=T.colorSpace,Y=T.format,$=T.type;return T.isCompressedTexture===!0||T.isVideoTexture===!0||V!==Xn&&V!==Nn&&(Zt.getTransfer(V)===te?(Y!==Qe||$!==Hn)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",V)),g}function ee(T){return typeof HTMLImageElement<"u"&&T instanceof HTMLImageElement?(c.width=T.naturalWidth||T.width,c.height=T.naturalHeight||T.height):typeof VideoFrame<"u"&&T instanceof VideoFrame?(c.width=T.displayWidth,c.height=T.displayHeight):(c.width=T.width,c.height=T.height),c}this.allocateTextureUnit=O,this.resetTextureUnits=x,this.setTexture2D=P,this.setTexture2DArray=W,this.setTexture3D=q,this.setTextureCube=H,this.rebindTextures=Ft,this.setupRenderTarget=Dt,this.updateRenderTargetMipmap=I,this.updateMultisampleRenderTarget=Kt,this.setupDepthRenderbuffer=rt,this.setupFrameBufferTexture=X,this.useMultisampledRTT=Bt}function Av(n,t){function e(i,r=Nn){let s;const o=Zt.getTransfer(r);if(i===Hn)return n.UNSIGNED_BYTE;if(i===Lc)return n.UNSIGNED_SHORT_4_4_4_4;if(i===Dc)return n.UNSIGNED_SHORT_5_5_5_1;if(i===qh)return n.UNSIGNED_INT_5_9_9_9_REV;if(i===Xh)return n.BYTE;if(i===jh)return n.SHORT;if(i===Pc)return n.UNSIGNED_SHORT;if(i===Rc)return n.INT;if(i===Xi)return n.UNSIGNED_INT;if(i===On)return n.FLOAT;if(i===Ss)return n.HALF_FLOAT;if(i===Yh)return n.ALPHA;if(i===Kh)return n.RGB;if(i===Qe)return n.RGBA;if(i===$h)return n.LUMINANCE;if(i===Zh)return n.LUMINANCE_ALPHA;if(i===ki)return n.DEPTH_COMPONENT;if(i===_r)return n.DEPTH_STENCIL;if(i===Jh)return n.RED;if(i===Ic)return n.RED_INTEGER;if(i===Qh)return n.RG;if(i===Uc)return n.RG_INTEGER;if(i===Nc)return n.RGBA_INTEGER;if(i===Fs||i===Bs||i===ks||i===Vs)if(o===te)if(s=t.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(i===Fs)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===Bs)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===ks)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===Vs)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=t.get("WEBGL_compressed_texture_s3tc"),s!==null){if(i===Fs)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===Bs)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===ks)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===Vs)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===La||i===Da||i===Ia||i===Ua)if(s=t.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(i===La)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===Da)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===Ia)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===Ua)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===Na||i===Oa||i===Fa)if(s=t.get("WEBGL_compressed_texture_etc"),s!==null){if(i===Na||i===Oa)return o===te?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(i===Fa)return o===te?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(i===Ba||i===ka||i===Va||i===za||i===Ha||i===Ga||i===Wa||i===Xa||i===ja||i===qa||i===Ya||i===Ka||i===$a||i===Za)if(s=t.get("WEBGL_compressed_texture_astc"),s!==null){if(i===Ba)return o===te?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===ka)return o===te?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===Va)return o===te?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===za)return o===te?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===Ha)return o===te?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===Ga)return o===te?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===Wa)return o===te?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===Xa)return o===te?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===ja)return o===te?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===qa)return o===te?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===Ya)return o===te?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===Ka)return o===te?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===$a)return o===te?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===Za)return o===te?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===zs||i===Ja||i===Qa)if(s=t.get("EXT_texture_compression_bptc"),s!==null){if(i===zs)return o===te?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===Ja)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===Qa)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===td||i===tl||i===el||i===nl)if(s=t.get("EXT_texture_compression_rgtc"),s!==null){if(i===zs)return s.COMPRESSED_RED_RGTC1_EXT;if(i===tl)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===el)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===nl)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===yr?n.UNSIGNED_INT_24_8:n[i]!==void 0?n[i]:null}return{convert:e}}class Pv extends Ne{constructor(t=[]){super(),this.isArrayCamera=!0,this.cameras=t}}class as extends Re{constructor(){super(),this.isGroup=!0,this.type="Group"}}const Rv={type:"move"};class po{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new as,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new as,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new R,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new R),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new as,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new R,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new R),this._grip}dispatchEvent(t){return this._targetRay!==null&&this._targetRay.dispatchEvent(t),this._grip!==null&&this._grip.dispatchEvent(t),this._hand!==null&&this._hand.dispatchEvent(t),this}connect(t){if(t&&t.hand){const e=this._hand;if(e)for(const i of t.hand.values())this._getHandJoint(e,i)}return this.dispatchEvent({type:"connected",data:t}),this}disconnect(t){return this.dispatchEvent({type:"disconnected",data:t}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(t,e,i){let r=null,s=null,o=null;const a=this._targetRay,l=this._grip,c=this._hand;if(t&&e.session.visibilityState!=="visible-blurred"){if(c&&t.hand){o=!0;for(const b of t.hand.values()){const f=e.getJointPose(b,i),d=this._getHandJoint(c,b);f!==null&&(d.matrix.fromArray(f.transform.matrix),d.matrix.decompose(d.position,d.rotation,d.scale),d.matrixWorldNeedsUpdate=!0,d.jointRadius=f.radius),d.visible=f!==null}const u=c.joints["index-finger-tip"],h=c.joints["thumb-tip"],p=u.position.distanceTo(h.position),m=.02,v=.005;c.inputState.pinching&&p>m+v?(c.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:t.handedness,target:this})):!c.inputState.pinching&&p<=m-v&&(c.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:t.handedness,target:this}))}else l!==null&&t.gripSpace&&(s=e.getPose(t.gripSpace,i),s!==null&&(l.matrix.fromArray(s.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,s.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(s.linearVelocity)):l.hasLinearVelocity=!1,s.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(s.angularVelocity)):l.hasAngularVelocity=!1));a!==null&&(r=e.getPose(t.targetRaySpace,i),r===null&&s!==null&&(r=s),r!==null&&(a.matrix.fromArray(r.transform.matrix),a.matrix.decompose(a.position,a.rotation,a.scale),a.matrixWorldNeedsUpdate=!0,r.linearVelocity?(a.hasLinearVelocity=!0,a.linearVelocity.copy(r.linearVelocity)):a.hasLinearVelocity=!1,r.angularVelocity?(a.hasAngularVelocity=!0,a.angularVelocity.copy(r.angularVelocity)):a.hasAngularVelocity=!1,this.dispatchEvent(Rv)))}return a!==null&&(a.visible=r!==null),l!==null&&(l.visible=s!==null),c!==null&&(c.visible=o!==null),this}_getHandJoint(t,e){if(t.joints[e.jointName]===void 0){const i=new as;i.matrixAutoUpdate=!1,i.visible=!1,t.joints[e.jointName]=i,t.add(i)}return t.joints[e.jointName]}}const Lv=`
void main() {
